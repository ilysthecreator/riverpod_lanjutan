...
import 'package:riverpod_lanjutan/core/theme/theme.dart';
import 'package:riverpod_lanjutan/features/dashboard/data/models/dashboard_model.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                const Icon(
                  Icons.trending_up, // dummy
                  size: 16,
                  color: AppTheme.successColor,
                ),
                const SizedBox(width: 4),
                const Text(
                  '0.0%', // dummy percentage
                  style: TextStyle(
                    fontSize: 12,
                    color: AppTheme.successColor,
                    fontWeight: FontWeight.w600,
